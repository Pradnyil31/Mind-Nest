...
class _HomeContentState extends ConsumerState<HomeContent> {
  ...
  Future<void> _checkAndRegenerateDailyRoutine(
    ...
    if (isNewDay) {
      // â”€â”€ Daily balanced routine generation â”€â”€
  ...
  ///
  /// Distribution table:
  ///   count=3 â†’ 1 M + 1 A + 1 E
  ///   count=5 â†’ 2 M + 2 A + 1 E
  ///   count=6 â†’ 2 M + 2 A + 2 E
  ///   count=8 â†’ 3 M + 3 A + 2 E
  ///
      ...
      builder: (context, snapshot) {
        ...
        return StreamBuilder<List<String>>(
          ...
          builder: (context, completionSnapshot) {
            ...
            // â”€â”€ Read wake/bed times directly from snapshot (fixes stale-state bug on cold start) â”€â”€
